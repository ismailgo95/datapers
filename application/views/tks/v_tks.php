              ...
              <tr class="text-nowrap">
                <td>
                  ...
                  <span data-toggle="tooltip" data-original-title="Hapus Data" style="font-size:10;" data-placement="left">
                    <a onclick="return confirm('Apakah ingin dihapus ?')" class="btn btn-sm btn-danger" href="<?= base_url('Admin/Tks/delete/' . $tks->id) ?>"><i class="fas fa-trash-alt"></i>
                    </a>
                  </span>
                </td>
